...
\newcommand\csharpstyle{\lstset{
		...
		emph=[1]{Task, JsonDocument, Vehicle, DataException, IDevice, VehiclesHubDatabase, VehiclesHub, Hub},
		emphstyle=[1]{\color{blue-violet}},
		emph=[2]{
			AddClient, Create, GetProperty, ExtractLane, CurrentLane, SetTravelPlan, StartNode, EndNode, Add, Update, Route, Details, Client, WaitForVehicles, Fetch, SendEventToAll, SendAsync, Start, MapHub, Patch, HandleIntersection, HandleEndOfRoute, HandleInsideIntersection,
		},
		emphstyle=[2]{\color{deepgreen}},
		emph=[3]{RootElement, Id, Context, ConnectionId, Velocity, Clients, SpeedLimit, All, Clock},
