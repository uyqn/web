...
After exhaustive discussions on how to solve the two-way communication discussed in \secref{phase2}, the group agreed that websockets would be a good solution to our problem. Using websockets both client and server can transfer data whenever they see fit. However, \cite{microsoft_websockets} discourage developers from implementing raw websockets for most applications, and recommends using SignalR instead.
