...
\begin{table}[h!]
	\begin{center}
		\begin{tabular}{rrrr}
			...
			\hline
		\end{tabular}
		\caption{Measurements taken to determine the relationship between power and velocity. Units were provided to the different parameters.}
		\label{tab:calibration}
	\end{center}
\end{table}

We then made a graph in Microsoft Excel by plotting our data with velocity on the $y$-axis and power on the $x$-axis as shown in \figref{fig:graphvelpow}.
