\chapter{Phases}
Our sprints each lasted two weeks, as per described in section \secref{section:scrum}, but in retrospect, it is apparent that we can divide our process into four phases:
